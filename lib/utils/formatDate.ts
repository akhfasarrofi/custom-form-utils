 ...
 */
function fromNow(timestamp: number | string): string {
 ...
 */
function startDate(type: ManipulateType, format?: string): string {
  if (format) {
 ...
 * @returns The resulting date after adding the specified value of the given type.
 */
function endDate(type: ManipulateType, format?: string) {
  if (format) {
 ...
 * @param {string | undefined} value The value date
 * @param {string} format The format to use for the returned date string (exp: YYYY-MM-DD)
 * @returns The resulting date after adding the specified value of the given type.
 */
function dates(value: string | undefined | Dayjs | null | Date, format?: string): string | Dayjs {
  if (format) {
 ...
 * @returns The resulting date after adding the specified value of the given type.
 */
function substract(value: number, type: ManipulateType, format?: string) {
  if (format) {
 ...
 * @returns The resulting date after adding the specified value of the given type.
 */
function addDate(value: number, type: ManipulateType, format?: string) {
  if (format) {
